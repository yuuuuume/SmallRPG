...
public class QuestManager : MonoBehaviour
{
    ...
    /*check the questToCheck is already checked true/false*/
    ...
    /* true:　if quest exists in quest arr
     call UpdateLocalQuestObjects() in order to update check box*/
    ...
    /* false, if the quest does not exist*/
    public void MarkQuestIncomplete(string questToMark)
    {
        questMarkersComplete[GetQuestNumber(questToMark)] = false;
       
    }
    /*return int: the index of the questToFInd*/
    ...
    /*if questObject exist, do CheckCompletion()*/
